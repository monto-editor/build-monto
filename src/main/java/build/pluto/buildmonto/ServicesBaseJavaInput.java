...
public class ServicesBaseJavaInput implements Serializable {
    ...
    public ServicesBaseJavaInput(File src, File target, File jarLocation, List<BuildRequest<?, ?, ?, ?>> requiredUnits) {
        this.src = src;
        this.target = target;
    ...
    public static void main(String[] args) throws IOException {
        ServicesBaseJavaInput input = new ServicesBaseJavaInput(new File("services-base-java"), new File("targetsb"), new File("sbj.jar"), null);
