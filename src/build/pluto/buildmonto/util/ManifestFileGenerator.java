...
public class ManifestFileGenerator extends Builder<ManifestFileGenerator.Input, None> {
	...
	public static BuilderFactory<Input, None, ManifestFileGenerator> factory = BuilderFactoryFactory.of(ManifestFileGenerator.class, Input.class);
	
	public ManifestFileGenerator(Input input) {
		super(input);
	}
